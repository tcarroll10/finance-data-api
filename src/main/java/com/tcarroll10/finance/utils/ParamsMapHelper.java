...
/**
 * ParamsMapHelper class for Finance data api service. Provides methods for
 * processing the request parameter strings.
 * 
 * @author tom carroll
 * @version 2023-12-27
 */
...
public class ParamsMapHelper {
    ...
    /**
     * Processes the fields request parameter. If the fields parameter is not
     * present or empty will return 'select *'. If present, will return a comma
     * separated list of the fields with whitespace trimmed.
     * 
    ...
    public static String processFields(Map<String, String> paramsMap) {
        ...
        if (values != null && !values.isEmpty()) {
            ...
            String[] fieldsArray = Arrays.stream(values.split(","))
    ...
    /**
     * Processes the 'filter' request parameter. If the parameter is not present
     * or empty will return empty string. If present, will return a comma
     * separated list of the fields with whitespace trimmed.
     * 
     * @param paramsMap map of parameters
     * @return the select portion of the sql statement
        ...
        if (values != null && !values.isEmpty()) {
            ...
            for (String item : filterArray) {
                ...
                if (!split[1].equals("in")) {
                    pieces.add(split[0] + " " + OperatorMapper.mapper(split[1])
                            + " " + "'" + split[2] + "'");
                } else {

                    String result = "";
                    List<String> result1 = new ArrayList<>();
                    String modifiedString = split[2].substring(1,
                            split[2].length() - 1);
    ...
    public static String processParamsMapToSql(String dataset,
    ...
    public static String[] splitFilterParam(String input) {
        ...
        while (matcher.find()) {
            ...
            result.add(matcher.group(1) != null ? matcher.group(1)
                    : matcher.group(2));
        }
