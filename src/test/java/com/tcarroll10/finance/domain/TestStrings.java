...
public class TestStrings {
  ...
  public void testSplit() {
    ...
    String a =
        "fields=record_date,security_type_desc,security_desc,avg_interest_rate_amt,src_line_nbr&filter=record_date:eq:2023-11-30";
    String[] b = a.split("&");
    assertEquals(b[0],
  ...
  public void testAddingToMap() {
    ...
    String testResult =
        "record_date,security_type_desc,security_desc,avg_interest_rate_amt,src_line_nbr";
